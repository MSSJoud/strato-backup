...
ARCHIVE_PATH = OUT_DIR / "punjab_phase1_baseline_prediction_full_scene_no_mask_seasonal_dates.h5"
S0_OUTPUT_PATH = OUT_DIR / "punjab_phase1_baseline_prediction_full_scene_no_mask_seasonal_dates_S0.nc"
SG_OUTPUT_PATH = OUT_DIR / "punjab_phase1_baseline_prediction_full_scene_no_mask_seasonal_dates_Sg.nc"
...
def main() -> None:
    ...
    end_indices = np.array([int(np.where(dates == pd.Timestamp(d))[0][0]) for d in TARGET_DATES], dtype=np.int32)
